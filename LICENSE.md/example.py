...
def Main():
    ...
    numresults=50 # number of articles per batch. for just sampling, use 50 or 100 per batch. for detailed analysis, use batchsize
    ...
    """
    search_string="emission"
    print("save figure - research topic evolution (as subplots) for: \""+search_string+"\"")
    research_field_evolution_subplots(search_string,'ti',2600,500,numresults)    
